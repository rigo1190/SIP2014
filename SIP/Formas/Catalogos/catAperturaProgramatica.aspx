<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catAperturaProgramatica.aspx.cs" Inherits="SIP.Formas.Catalogos.catAperturaProgramatica" %>
...
<div id="contenedor" runat="server" class="container">
        ...
        <div runat="server" style="display:none">
            ...
            <input type="hidden" runat="server" id="_IdMeta"       />
        </div>
    ...
    <div id="divMetas" runat="server">
        ...
        >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Unidad de Medida">
                        <EditItemTemplate>
                            <asp:TextBox CssClass="input-sm" ID="txtUnidad" runat="server" Text='<%# Bind("AperturaProgramaticaUnidad.Nombre") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("AperturaProgramaticaUnidad.Nombre") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Beneficiario">
                        <EditItemTemplate>
                            <asp:TextBox CssClass="input-sm" ID="txtBeneficiario" runat="server" Text='<%# Bind("AperturaProgramaticaBeneficiario.Nombre") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("AperturaProgramaticaBeneficiario.Nombre") %>'></asp:Label>
                        </ItemTemplate>
                    <ItemStyle  Width="100px"  />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgBtnEditMeta" ToolTip="Editar" runat="server" ImageUrl="~/img/Edit1.png" OnClick="imgBtnEditMeta_Click" />
                            <asp:ImageButton ID="imgBtnEliminarMeta" ToolTip="Borrar" runat="server" ImageUrl="~/img/close.png" OnClick="imgBtnEliminarMeta_Click" OnClientClick="return fnc_Confirmar()" />
        ...
        <div class="row">
            ...
            <div class="col-md-4"> 
                <asp:DropDownList ID="ddlBeneficiario" CssClass="form-control" runat="server"></asp:DropDownList> 
            </div>

            <div class="col-md-2">
                <asp:Button  CssClass="btn btn-default" Text="Agregar Meta" Id="btnMetaGuardar" runat="server"  AutoPostBack="false" OnClick="btnMetaGuardar_Click" />
                <asp:Button  CssClass="btn btn-default" Text="Guardar Cambios" Id="btnMetaUpdate" runat="server"  AutoPostBack="false" OnClick="btnMetaUpdate_Click"/>
                
            </div>

            <div class="col-md-2">
                <asp:Button  CssClass="btn btn-default" Text="Cancelar Cambios" Id="btnMetaCancelarCambios" runat="server"  AutoPostBack="false" OnClick="btnMetaCancelarCambios_Click" />
            </div>
        </div>        
