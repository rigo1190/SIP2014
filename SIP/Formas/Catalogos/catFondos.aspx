<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorCatalogos.Master" AutoEventWireup="true" CodeBehind="catFondos.aspx.cs" Inherits="SIP.Formas.Catalogos.catFondos" %>
            ...
            <div id="divcaptura" runat="server" class="panel panel-success">
                ...
                <div class="row top-buffer">
                       <div class="col-md-2"> 
                        ...
                        <div class="col-md-6">
                            <asp:textbox width="180px" id="txtAbreviatura" text="0" cssclass="form-control" runat="server"></asp:textbox>
                        </div>
                    </div>
