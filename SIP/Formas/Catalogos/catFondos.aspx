...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        function fnc_Validar() {
            ...
            desc = $("#<%= txtAbreviatura.ClientID%>").val();
            if (desc == null || desc.length == 0 || desc == undefined) {
                $("#custom-menu").hide(); //Se oculta el menu contextual 
                $("#msgContenido").text("El campo ABREVIATURA no puede ir vacío"); //Se cambia el mensaje del dialogo modal de confirmacion
                $("#myModal").modal('show') //Se muestra el modal
                return false;
            }
            ...
            desc = $("#<%= txtOrden.ClientID%>").val();
            if (desc == null || desc.length == 0 || desc == undefined) {
                $("#custom-menu").hide(); //Se oculta el menu contextual 
                $("#msgContenido").text("El campo ORDEN no puede ir vacío"); //Se cambia el mensaje del dialogo modal de confirmacion
                $("#myModal").modal('show') //Se muestra el modal
                return false;
            }
    ...
    <div id="contenedor" runat="server" class="container">
            ...
            <div id="divDatos" >
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title">Catálogo de Fondos</h3>
                        <div class="pull-right"><span class="glyphicon glyphicon-print"></span></div>
                    </div>
                        ...
                        <asp:TreeView runat="server" SelectedNodeStyle-ForeColor="Black" AutoPostBack="false" ID="treeMain"  ShowLines="True"  NodeIndent="25"  AutoGenerateDataBindings="False" Width="117px" OnSelectedNodeChanged="treeMain_SelectedNodeChanged" >
                         ...
                         <div id="custom-menu">
                                <ol>
                                    ...
                                    <li>
                                        <asp:Button ID="addsp" Width="160px" AutoPostBack="false" CssClass="btn btn-default evento" OnClientClick="return false"  runat="server" Text="Agregar Fondo" /> 
                                    </li>
        ...
        <asp:LinkButton ID="idLinkRPT" runat="server" PostBackUrl="~/rpts/wfVerReporte.aspx?nombreRPT='CrystalReport1.rpt'">Ver Reporte</asp:LinkButton>
            ...
            <div id="divcaptura" runat="server" class="panel panel-success">
                    ...
                    <span runat="server" id="SpanFondo" class="label label-primary">Agregando Fondo ...</span>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-8">
                              ...
                              <div class="form-group">
                                   ...
                                   <div>
                                       <input type="text" class="input-sm required form-control" id="txtAbreviatura" runat="server" autocomplete="off" />                           
                                   </div>
                               </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div>
                                       <input type="text" class="input-sm required form-control" id="txtOrden" runat="server" autocomplete="off" />                           
                                   </div>
                               </div>

                              <div class="form-group">
                                   <label for="TipoFondo">Tipo</label>
                                   <div>
                                       <asp:DropDownList ID="ddlTipoFondo" CssClass="form-control" runat="server"></asp:DropDownList>                           
                                   </div>
                               </div>
                             ...
                             <div class="form-group" id="divguardar" runat="server">
                                <asp:Button  CssClass="btn btn-default" Text="Guardar" Id="btnGuardar" runat="server"   OnClick="btnGuardar_Click" AutoPostBack="false" />
                   ...
                   <%--<div class="form-group">
                       <div > 
                        ...
                        <div>
                            <asp:textbox id="txtClave" text="0" cssclass="form-control" runat="server"></asp:textbox>                            
                        </div>
                    </div>--%>

                   <%--<div class="row top-buffer">
                           <div class="col-md-2"> 
                                <p class="text-right"><strong>Abreviatura</strong></p>
                            </div>
                            <div class="col-md-6">
                                <asp:textbox  id="txtAbreviatura" text="0" cssclass="form-control" runat="server"></asp:textbox>
                            </div>
                  </div>--%>
                  ...
                  <%-- <div class="row top-buffer">
                       <div class="col-md-2"> 
                        ...
                        <div class="col-md-10">
                            <asp:textbox textmode="multiline" id="txtNombre" cssclass="form-control" runat="server"></asp:textbox>
                        </div>
                    </div>--%>
                  ...
                  <%-- <div class="row top-buffer">
                       <div class="col-md-2"> 
                            <p class="text-right"><strong>Tipo</strong></p>
                        </div>
                        <div class="col-md-6">
                            <asp:DropDownList ID="ddlTipoFondo" CssClass="form-control" runat="server"></asp:DropDownList>
                        </div>
