...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-warning" runat="server" id="divMSGnoHayContrato">
        ...
        <div id="divCargarArchivo" class="row" runat="server">
            ...
            <div class="col-md-4" runat="server" id="divGuardarPresupuesto">
                <asp:Button  CssClass="btn btn-primary" Text="Guardar Presupuesto Contratado" ID="btnGuardarPresupuestoContratado" runat="server" AutoPostBack="false" OnClick="btnGuardarPresupuestoContratado_Click" />
            </div>
