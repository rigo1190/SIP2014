<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="POAAjustadoEvaluacion.aspx.cs" Inherits="SIP.Formas.POA.POAAjustadoEvaluacion" %>
            ...
            <div class="row">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <asp:GridView  ShowHeaderWhenEmpty="true" CssClass="table" ID="grid" DataKeyNames="Id" AutoGenerateColumns="False" runat="server" AllowPaging="True">
                            <Columns>
