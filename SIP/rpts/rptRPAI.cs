...
namespace SIP.rpts {
    ...
    public class rptRPAI : ReportClass {
    ...
    public class CachedrptRPAI : Component, ICachedReport {
        
        public CachedrptRPAI() {
        }
